...
class Translator(object):
    ...
    def translate_batch(self, batch_inputs):
        ...
        lengths_node=batch_inputs['lengths_node']
...
#             gnn_out = torch.stack(batch_input, 0)
            ...
            lengths_node = lengths_node.repeat(beam_size)
            dec_states = decoder.init_decoder(src_lens, memory_bank.shape[1],lengths_node,gnn_out.shape[1])
        else:
            gnn_out = None
